...
<?php
  foreach($order_list as $OrderOut)
  {
      ...
      <td> <a href=?controller=order&action=updateFormOrder&orderId=$OrderOut->orderId> Update </a></td>
      <td> <a href=?controller=order&action=deleteConfirmOrder&orderId=$OrderOut->orderId> Delete </a></td>
      </tr>";
  }
echo "</table>";
?>
